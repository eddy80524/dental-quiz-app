...
# 後方互換性のためのエイリアス
LEVEL_ORDER = UNIFIED_LEVEL_ORDER
...
# 国試科目リスト
KOKUSHI_BASIC_SUBJECTS = [
    "解剖学", "歯科理工学", "組織学", "生理学", "病理学", "薬理学", 
    "微生物学・免疫学", "衛生学", "発生学・加齢老年学", "生化学"
]

KOKUSHI_CLINICAL_SUBJECTS = [
    "保存修復学", "歯周病学", "歯内治療学", "クラウンブリッジ学", "部分床義歯学", 
    "全部床義歯学", "インプラント学", "口腔外科学", "歯科放射線学", "歯科麻酔学", 
    "矯正歯科学", "小児歯科学"
]

# 学士試験科目リスト
GAKUSHI_BASIC_SUBJECTS = [
    "倫理学", "化学", "歯科理工学", "生理学", "法医学教室", "口腔病理学", 
    "薬理学", "生物学", "口腔衛生学", "口腔解剖学", "生化学", "物理学", 
    "解剖学", "細菌学"
]

GAKUSHI_CLINICAL_SUBJECTS = [
    "内科学", "歯周病学", "口腔治療学", "有歯補綴咬合学", "欠損歯列補綴咬合学", 
    "歯科保存学", "口腔インプラント", "口腔外科学1", "口腔外科学2", "歯科放射線学", 
    "歯科麻酔学", "歯科矯正学", "障がい者歯科", "高齢者歯科学", "小児歯科学"
]
