...
def load_master_data():
    ...
    # 読み込むファイルを直接指定する
    files_to_load = ['master_questions_final.json', 'gakushi-2022-1-1.json', 'gakushi-2022-1-2.json', 'gakushi-2022-1-3.json', 'gakushi-2024-1-1.json', 'gakushi-2024-2.json', 'gakushi-2025-1-1.json']
