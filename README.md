...
間隔反復学習（SM2アルゴリズム）を活用した効率的な国家試験対策システム

## 📚 ドキュメント

- **[セットアップガイド](docs/SETUP.md)** - 環境構築と初期設定
- **[デプロイ手順](docs/DEPLOYMENT.md)** - Cloud Functionsとアプリのデプロイ方法
- **[アーキテクチャ](docs/ARCHITECTURE.md)** - システム構成と技術スタック
- **[開発ガイド](DEVELOPMENT_GUIDE.md)** - 詳細な開発者向けドキュメント
